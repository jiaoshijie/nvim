...
vim.api.nvim_exec([[
  augroup jsj_Markdown
    autocmd!
    autocmd FileType markdown nnoremap <buffer> <silent> <localleader>f /<++><cr>:nohl<cr>"_c4l
    autocmd FileType markdown inoremap <buffer> <localleader>f <Esc>/<++><cr>:nohl<cr>"_c4l
