...
Group.new('VertSplit', c.bg3, c.bg0)
...
Group.new('LineNr', c.bg4, c.none, b)
...
Group.new('Operator', g.Normal, g.Normal, g.Normal)
...
Group.new('LspDiagnosticsDefaultInformation'     , c.aqua   , c.none          , no)
...
Group.new('LspDiagnosticsVirtualTextInformation' , c.aqua   , c.bg2           , i)
Group.new('LspDiagnosticsVirtualTextHint'        , c.green  , c.bg2           , i)
...
Group.new('LspDiagnosticsUnderlineInformation'   , c.none   , c.none          , uc  , c.aqua)
...
Group.new('LspDiagnosticsFloatingInformation'    , c.aqua   , c.none          , ul)
...
Group.new('LspDiagnosticsSignInformation'        , c.aqua   , c.none          , no)
